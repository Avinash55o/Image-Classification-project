...
export default function HOME(){
    ...
    return(
      ...
      <div className="z-10 w-full max-w-2xl flex flex-col items-center">
        <h1 className="text-5xl font-extrabold mb-2 tracking-tight bg-linear-to-br from-indigo-300 via-white to-neutral-400 bg-clip-text text-transparent text-center drop-shadow-lg">
          AI Image Classifier
        </h1>
        <p className="text-neutral-400 text-lg mb-10 font-light tracking-wide">
          Unlock the content of your images with a single click.
        </p>
          ...
          <button
            ...
            className={`w-full mt-6 py-4 rounded-xl font-semibold text-lg transition-all duration-300 flex items-center justify-center gap-2
              ${!file
                ...
                : 'bg-linear-to-r from-indigo-500 to-purple-500 text-white shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 hover:scale-[1.02] active:scale-[0.98]'
              }
